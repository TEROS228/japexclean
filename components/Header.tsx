      ...
      <header className="bg-white border-b border-gray-200/50 shadow-lg transition-all duration-300">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-4">
          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4 mb-3 sm:mb-4">
            ...
            {/* Marketplace Switcher - скрыт на мобильных, показывается в меню */}
            <div className="hidden md:flex relative items-center gap-0 p-0.5 bg-white rounded-full border-2 border-gray-200 shadow-sm">
