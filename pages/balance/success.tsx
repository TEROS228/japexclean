// pages/balance/success.tsx
import { useEffect, useState } from 'react';
import { useRouter } from 'next/router';
import Link from 'next/link';
import { getAuthToken, updateUserBalance } from '@/lib/auth';
...
export default function BalanceSuccessPage() {
  ...
  useEffect(() => {
    ...
    const processPayment = async () => {
      ...
      if (!sessionId) {
        window.location.href = '/balance?topup=error';
        return;
      }
      ...
      try {
        ...
        updateUserBalance(updateData.newBalance);
