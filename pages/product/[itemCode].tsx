  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-0 sm:px-4 py-4 sm:py-6">
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="flex flex-col">
            ...
            {product.mediumImageUrls && product.mediumImageUrls.length > 1 && (
              <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-2 px-3 sm:px-0">
          ...
          <div className="space-y-2 sm:space-y-3 px-3 sm:px-0">
            {/* Карточка продукта */}
        ...
        {product?.itemCaption && (
          <div className="mt-4 sm:mt-6 mx-3 sm:mx-0 bg-white rounded-lg sm:rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        {!loadingRecommendations && recommendations.length > 0 && (
          <div className="px-3 sm:px-4 py-6 sm:py-8 mt-6 sm:mt-8">
